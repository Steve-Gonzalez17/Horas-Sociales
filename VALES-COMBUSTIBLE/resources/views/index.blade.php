            ...
            <form class="p-4 md:p-5 ">
                ...
                <div class="grid gap-2 mb-10 md:grid-cols-3">
                    ...
                    <div>
                        <label class="form-control w-full max-w-xs">
                            <div class="label">
                                <span class="label-text text-white">Convercion</span>
                            </div>
                            <input type="number" placeholder="Type here"
                                class="bg-gray-50 border border-gray-300 input input-bordered w-full max-w-xs" />
                            <div class="divider divider-error text-white">Total galones por VALE</div>
                            <input type="number" placeholder="Type here"
                                class="bg-gray-50 border border-gray-300 input input-bordered w-full max-w-xs" />
                        </label>
                    </div>
                    <div>
                        <label class="form-control w-full max-w-xs">
                            <div class="label">
                                <span class="label-text text-white">No.Requisicion</span>
                            </div>
                            <input type="number" placeholder="Type here"
                                class="bg-gray-50 border border-gray-300 input input-bordered w-full max-w-xs" />
                        </label>
